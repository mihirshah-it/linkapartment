...
<HEAD>
   ...
   <TITLE><spring:message code="common.title.label.product"/> :: <spring:message code="appmenu.lable.manageAccount"/></TITLE> 
   <!-- CSS Files -->
...
String subMenu  = "";
pageCode = PageCode.MANAGE_ACCOUNT;
...
<div class="contentBg">
	...
	<hsCommonTag:breadCrumb pageTitle="Account" isFirstIndex="true" isSocietyNameDisplay="false"/>
...
<script type="text/javascript" src="<%=jsRoot%>/account/manageAccountDashboard.js?${Server_Token_Value}"></script>
<script>
	showSocietyDiv();
</script>
</html>