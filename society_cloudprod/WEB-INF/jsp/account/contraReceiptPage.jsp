...
Long contraId = (Long)request.getAttribute("contraId");
request.getSession().setAttribute(ImageServlet.DEFAULT_JASPER_PRINT_SESSION_ATTRIBUTE, jp);
%>
<html>
<HEAD>
	<%@include file="../common/appMetaConfig.jsp"%>
   <TITLE><spring:message code="common.title.label.product"/> :: Contra Details</TITLE>    
</HEAD>
...
<%@include file="../common/header.jsp"%>
  ...
  <div class="content-wrapper">
	<nav class="navbar-static-top">
  	<div id="subNavBar" class="navbar-collapse collapse in">
          <ul class="nav navbar-nav">
			...
			<li>
				<a  href="javascript:;"  onclick="javascript:printContraReceipt();"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Print</a>				
			</li>			
          </ul>
     </div>
     </nav>
    ...
    <section class="content-header">
		  <h1>Contra Details</h1>
		  <hsCommonTag:breadCrumb pageTitle="Contra Details" isFirstIndex="false"/>
	 </section>
	 	...
	 	<div class="row">
    		<div class="col-md-12">
    				<form id="contraReceiptForm" method="post">
						 <input type="hidden" id="voucherId" name="voucherId" value="<%=contraId%>">
					</form>
...
<script src="<%=jsRoot%>/account/contraReceiptPage.js?${Server_Token_Value}" type="text/javascript"></script>
</body>
</html>