...
Long incomeId = (Long)request.getAttribute("receiptEntryId");
request.getSession().setAttribute(ImageServlet.DEFAULT_JASPER_PRINT_SESSION_ATTRIBUTE, jp);
%>
<html>
<HEAD>
	<%@include file="../common/appMetaConfig.jsp"%>
   <TITLE><spring:message code="common.title.label.product"/> :: Receipt Details</TITLE>    
</HEAD>
...
<%@include file="../common/header.jsp"%>
  ...
  <div class="content-wrapper">
	<nav class="navbar-static-top">
  	<div id="subNavBar" class="navbar-collapse collapse in">
          <ul class="nav navbar-nav">
			...
			<li>
				<a  href="javascript:;"  onclick="javascript:printIncomeReceipt();"><i class="fa fa-print" aria-hidden="true"></i>&nbsp;Print</a>				
			</li>			
          </ul>
     </div>
     </nav>
    ...
    <section class="content-header">
		  ...
		  <hsCommonTag:breadCrumb pageTitle="Receipt Details" isFirstIndex="false"/>
	 </section>
	 	...
	 	<div class="row">
    		<div class="col-md-12">
    				<form id="incomeReceiptForm" method="post">
						 <input type="hidden" id="voucherId" name="voucherId" value="<%=incomeId%>">
					</form>
...
<script src="<%=jsRoot%>/account/incomeReceiptPage.js?${Server_Token_Value}" type="text/javascript"></script>
</body>
</html>