...
<HEAD>
   ...
   <TITLE><spring:message code="common.title.label.product"/> :: Manage Payment</TITLE>
</HEAD>
<%
...
<%@include file="../common/header.jsp"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
		  <h1><spring:message code="expense.manage.petty.cash.page.header"/></h1>
		  <hsCommonTag:breadCrumb pageTitle="Manage Payment" isFirstIndex="true"/>
	 </section>
    				...
    				<div class="box box-primary">
						...
						<%if (pageRenderMode.equals(CommonConstant.CREATE_MODE)  || pageRenderMode.equals(CommonConstant.EDIT_MODE)) {%>
								<div class="box-header with-border">  		
					    			<button class="col-md-3 btn btn-primary margin" onclick="javascript:addNewReceipt();"><spring:message code="expense.btn.add.pettycash"/></button>
						...
						<%}%>						
						<div class="box-body">
							<table id="societyPettyCashGridDiv" class="table table-bordered table-striped table-hover dt-responsive">
							</table>
						</div>
...
<div class="modal fade" id="attachementPopupForm" tabindex="-1" role="dialog" aria-labelledby="Upload Payment">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <div class="modal-footer">
        ...
        <button type="button" name="attachementSaveBtn" id="attachementSaveBtn" onclick="javascript:processPaymentImport();" class="btn btn-primary"><spring:message code="common.button.saveAndClose"/></button>
	  </div>
    </div>
    </div> 
</div>
...
<div class="modal fade" id="popupNoOfRecordsImportForm" tabindex="-1" role="dialog" aria-labelledby="Download Template">
	...
	<div class="modal-content">
        ...
        <h4 class="modal-title">Download Template :</h4>
      	...
      	<div class="modal-footer">
        	<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
        	<button type="button" onclick="javascript:downloadPaymentImportTemplate();" class="btn btn-primary">Download Template</button>
	  	</div>
	 </div>
	 </div>
</div>
...
<script>
  ...
  var attachementModuleId = '<%=ImportExportEntityType.ACCOUNT_PAYMENT_IMPORT%>';

</script>  
<script src="<%=jsRoot%>/common/attachmentUpload.js?${Server_Token_Value}" type="text/javascript"></script>
<script src="<%=jsRoot%>/account/managePaymentEntryPage.js?${Server_Token_Value}" type="text/javascript"></script>
</body>
</html>