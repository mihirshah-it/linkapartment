...
<HEAD>
   ...
   <TITLE><spring:message code="common.title.label.product"/> :: Manage Debit Notes Entry</TITLE> 
</HEAD>
<%
...
<%@include file="../common/header.jsp"%>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
		  ...
		  <hsCommonTag:breadCrumb pageTitle="Manage Debit Notes Entry" isFirstIndex="true"/>
	 </section>
    				...
    				<div class="box box-primary">
						<div class="box-header with-border">
							<%if (pageRenderMode.equals(CommonConstant.CREATE_MODE)  || pageRenderMode.equals(CommonConstant.EDIT_MODE)) {%>	
								<button type="button" onclick="addNewJournalEntry();" class="btn btn-primary"><spring:message code="account.manage.debit.notes.entry.page.btn.add.journalEntry"/></button>
							<%}%>
						</div>
						<div class="box-body">
...
<script src="<%=jsRoot%>/account/manageDebitNotesEntryPage.js?${Server_Token_Value}" type="text/javascript"></script>
</body>
</html>