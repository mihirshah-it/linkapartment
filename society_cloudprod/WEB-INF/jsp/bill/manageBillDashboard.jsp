...
<HEAD>
   ...
   <TITLE><spring:message code="common.title.label.product"/> :: <spring:message code="appmenu.lable.manageBills"/></TITLE> 
   <!-- CSS Files -->
...
<div class="contentBg">
	...
	<hsCommonTag:breadCrumb pageTitle="Member Bills" isFirstIndex="true" isSocietyNameDisplay="false"/>
...
<script type="text/javascript" src="<%=jsRoot%>/bill/manageBillDashboard.js?${Server_Token_Value}"></script>
<script>
	showSocietyDiv();
</script>
</html>