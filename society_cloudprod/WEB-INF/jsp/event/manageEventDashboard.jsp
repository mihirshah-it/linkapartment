...
<HEAD>
   ...
   <TITLE><spring:message code="common.title.label.product"/> :: Manage Communication</TITLE> 
   <!-- CSS Files -->
...
String subMenu  = "";
pageCode = PageCode.COMMUNICATION;
...
<div class="contentBg">
	...
	<hsCommonTag:breadCrumb pageTitle="Communication" isFirstIndex="true" isSocietyNameDisplay="false"/>
...
<script type="text/javascript" src="<%=jsRoot%>/event/manageEventDashboard.js?${Server_Token_Value}"></script>
<script>
	showSocietyDiv();
</script>
</html>